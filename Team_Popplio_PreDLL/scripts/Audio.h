...
\brief  
    This is the header file for the file Audio.cpp
...
namespace BassNKick
{
    class Audio : public ILogicScript // Script here (Similar to Unity Monobehaviour)
    {
    private:
    ...
    public:
        ...
        Audio(Entity* e) : ILogicScript(e) {}

        void Deserialize(std::string const& s) override;
        void Serialize() override;

        Audio& GetScript() override;
