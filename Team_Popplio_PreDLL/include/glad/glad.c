...
PFNGLMeshPARAMETERFSGIXPROC glad_glMeshParameterfSGIX = NULL;
PFNGLMeshPARAMETERFVSGIXPROC glad_glMeshParameterfvSGIX = NULL;
PFNGLMeshPARAMETERISGIXPROC glad_glMeshParameteriSGIX = NULL;
PFNGLMeshPARAMETERIVSGIXPROC glad_glMeshParameterivSGIX = NULL;
...
static void load_GL_NV_point_Mesh(GLADloadproc load) {
	if(!GLAD_GL_NV_point_Mesh) return;
...
static void load_GL_SGIX_Mesh(GLADloadproc load) {
	if(!GLAD_GL_SGIX_Mesh) return;
	glad_glMeshParameterfSGIX = (PFNGLMeshPARAMETERFSGIXPROC)load("glMeshParameterfSGIX");
	glad_glMeshParameterfvSGIX = (PFNGLMeshPARAMETERFVSGIXPROC)load("glMeshParameterfvSGIX");
	glad_glMeshParameteriSGIX = (PFNGLMeshPARAMETERISGIXPROC)load("glMeshParameteriSGIX");
	glad_glMeshParameterivSGIX = (PFNGLMeshPARAMETERIVSGIXPROC)load("glMeshParameterivSGIX");
}
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_ARB_point_Mesh = has_ext("GL_ARB_point_Mesh");
	...
	GLAD_GL_NV_point_Mesh = has_ext("GL_NV_point_Mesh");
	...
	GLAD_GL_SGIX_Mesh = has_ext("GL_SGIX_Mesh");
