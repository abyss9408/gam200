...
\brief
    This is the header file for the file Floor.cpp
...
namespace BassNKick
{
    class Floor : public ILogicScript // Script here (Similar to Unity Monobehaviour)
    {
    private:
        const float FLOOR_WIDTH = 2000.0f;
        const float FLOOR_HEIGHT = 200.0f;
    public:

        Floor(Entity* e) : ILogicScript(e) {}

        void Deserialize(std::string const& s) override;
        void Serialize() override;

        Floor& GetScript() override;
